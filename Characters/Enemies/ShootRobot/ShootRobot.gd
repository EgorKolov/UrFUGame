...
const THROWABLE_LASER_SCENE: PackedScene = preload("res://Characters/Enemies/ShootRobot/LaserBullet.tscn")
...
func _throw_laser() -> void:
	var projectile: Area2D = THROWABLE_LASER_SCENE.instance()
